...
# word_list =['book','libro','toy','juguete','read','leer','lectura','coleccionable','collectable','play','jugar','juego','puzzle','doll','mueco']
word_list = ['hotel','hostel','restaurant','hotel luxury','hotel young','shopping','shopping trendy','shopping luxury','kids','kid','kid tourism','kid hotel','hotel bar','bar','nightlife','club','club nightlife','fun','tourism','culture','craftnotcrap','spanishbeer','shoppingtime','shoppingday','flaxkale','cangambus','teresacarles','brunch','airbnb','luxuryhotels','designhotel','lobby','concert','music','nightlife','hostelife','youth','hostelbarcelona']
...
for e,cur_q in enumerate(q):
    print(cur_q)
    cur_w = w[e]
    results_path = "../../../datasets/instaBarcelona/retrieval_results/" + data + "/" + cur_q.replace(' ', '_') + '__' + cur_w.replace(' ', '_') + '/'
